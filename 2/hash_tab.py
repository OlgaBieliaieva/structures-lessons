...
# Ці значення, які повертає хеш-функція, 
# потім використовуються для визначення місця в хеш-таблиці, де зберігатиметься значення.

# Замість порівняння файлів напряму, що може бути дуже тривалим процесом, особливо для великих файлів, 
# ми порівнюємо їхні хеші, що дозволить нам швидко знайти дублікати.
def get_hash(path):
